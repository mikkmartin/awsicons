...
function SvgArchAwsCloudFormation32(props) {
	return (
		<svg width={40} height={40} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" {...props}>
			<defs>
				<linearGradient
					...
					x2="100%"
					y2="0%"
					id="Arch_AWS-CloudFormation_32_svg__a"
				>
			...
			<g fill="none" fillRule="evenodd">
					...
					fill="url(#Arch_AWS-CloudFormation_32_svg__a)"
				/>
			</g>
		</svg>
	);
...
export default SvgArchAwsCloudFormation32;
